...
public class UIAltaTitular {
	...
	public static void iniciar() {
		final Marco frmAltaTitular = new Marco(800,600,"Gestor de licencias - Alta titular");
		frmAltaTitular.getContentPane().setLayout(null);
		frmAltaTitular.setLocationRelativeTo(null);
		frmAltaTitular.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		...
		;
				...
				btnAtras.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						UIPrincipal.iniciar();
						 frmAltaTitular.dispose();
					}
				});
				btnAtras.setBounds(545, 493, 89, 23);
				frmAltaTitular.getContentPane().add(btnAtras);
	}
